...
public class Login extends JFrame {
    ...
    private JLabel lblEmpId, lblPassword;
    ...
    public Login() {
        ...
        layout.putConstraint(SpringLayout.WEST, lblEmpId, 6, SpringLayout.WEST, panel);
        ...
        layout.putConstraint(SpringLayout.NORTH, lblEmpId, 6, SpringLayout.NORTH, panel);
        layout.putConstraint(SpringLayout.NORTH, txtUserName, 6, SpringLayout.NORTH, panel);
        layout.putConstraint(SpringLayout.NORTH, lblPassword, 10, SpringLayout.SOUTH, lblEmpId);
        layout.putConstraint(SpringLayout.NORTH, txtPassword, 6, SpringLayout.SOUTH, txtUserName);

        // Set textfield position: right
        layout.putConstraint(SpringLayout.WEST, txtUserName, 8, SpringLayout.EAST, lblEmpId);
