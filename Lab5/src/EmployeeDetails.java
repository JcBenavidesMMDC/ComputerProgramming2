        ...
        editButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (!isEditing) {
                    ...
                    txtPhealthNumber.setEnabled(true);
                    txtTinNumber.setEnabled(true);
                    txtPagibigNumber.setEnabled(true);
                    txtBasicSalary.setEnabled(true);
                    ...
                    if (txtEmployeeNumber.getText().isEmpty() ||
                            txtLastName.getText().isEmpty() ||
                            txtFirstName.getText().isEmpty() ||
                            txtSssNumber.getText().isEmpty() ||
                            txtPhealthNumber.getText().isEmpty() ||
                            txtTinNumber.getText().isEmpty() ||
                            txtPagibigNumber.getText().isEmpty() ||
                            txtBasicSalary.getText().isEmpty() ||
                            txtHourlyRate.getText().isEmpty()) {

                        // Show a popup message if any field is empty
                        JOptionPane.showMessageDialog(null, "Please fill out all fields before saving.", "Incomplete Form", JOptionPane.WARNING_MESSAGE);
                    } else {
